...
protected:
        ...
        ulong invalidations, interventions, flushes, I2E, I2S, M2S, E2S, S2M, I2M, E2M, O2M, M2O, M2I;
...
public:
    ...
    void print_stats_dir(int, int, int);

    virtual void PrRd(ulong, int) = 0;
    virtual void PrWr(ulong, int) = 0;
    virtual void PrRdDir(ulong, int) = 0;
    virtual void PrWrDir(ulong, int) = 0;
...
public:
	...
	static Cache* create_cache( int protocol_no, int size, int assoc, int block_size, int num_processor, int processor_num);
};
